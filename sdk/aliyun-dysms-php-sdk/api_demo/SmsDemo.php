...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIwzpKfWKxc22R"; // AccessKeyId

        $accessKeySecret = "PyhpX3nurksCvlTKRvXZZExUPmMdxo"; // AccessKeySecret
    ...
    public static function sendSms() {
        ...
        // 必填，设置短信接收号码
        $request->setPhoneNumbers("18355613657");

        // 必填，设置签名名称，应严格按"签名名称"填写，请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/sign
        $request->setSignName("喜勃");
